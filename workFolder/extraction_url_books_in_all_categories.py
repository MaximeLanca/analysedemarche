...
from workFolder.book_informations import get_book_informations_in_html_page
...
def get_all_url_categories():
    ...
    for categories_url_reconstitution in categories_url_reconstitution:
        ...
        for books_links in soup.find('ol', class_='row').find_all('a', title=True):
            books_url_reconstitution.append((link_book_from_catalogue_web_page + books_links['href'])
                                            .replace('../../../', ''))
